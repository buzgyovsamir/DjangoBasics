...
from reviews.views import recent_reviews, review_datils, review_edit, review_delete, review_create, review_bulk_update
...
reviews_patterns = [
    ...
    path('<slug:book_slug>/', review_bulk_update, name= 'bulk_update'),
